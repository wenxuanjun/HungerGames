...
public enum PotionTypeUtils {
    ...
    LEAPING("JUMP"),
    LONG_LEAPING("LONG_JUMP"),
    STRONG_LEAPING("STRONG_JUMP"),
    FIRE_RESISTANCE("FIRE_RESISTANCE"),
    LONG_FIRE_RESISTANCE("LONG_FIRE_RESISTANCE"),
    SWIFTNESS("SPEED"),
    LONG_SWIFTNESS("LONG_SPEED"),
    STRONG_SWIFTNESS("STRONG_SPEED"),
    SLOWNESS("SLOWNESS"),
    ...
    STRONG_HEALING("STRONG_INSTANT_HEAL"),
    HARMING("INSTANT_DAMAGE"),
    STRONG_HARMING("STRONG_INSTANT_DAMAGE"),
    POISON("POISON"),
    LONG_POISON("LONG_POISON"),
    STRONG_POISON("STRONG_POISON"),
    REGENERATION("REGEN"),
    LONG_REGENERATION("LONG_REGEN"),
    STRONG_REGENERATION("STRONG_REGEN"),
    STRENGTH("STRENGTH"),
